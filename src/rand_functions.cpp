// Contains functions for generating multivariate normal samples (for Eigen matrices) and 
// Generalized Inverse Gaussian samples (using the algorithm of Hormann & Leydold (2014)).
